...
if img1 is None or img2 is None:
    raise FileNotFoundError("Could not load frame.png or frame2.png")
...
# CLAHE for illumination variation
...
# ----------------------------
# Overlay motion on image 2
# ----------------------------
overlay = img2.copy()
overlay[mask > 0] = (0, 0, 255)
vis = cv.addWeighted(img2, 0.75, overlay, 0.25, 0)

print(f"Robust threshold used: T={T} (sigma≈{sigma:.2f}, k={k})")
